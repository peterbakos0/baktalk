...
var notifyAboutDeleteReactionOperation = async (reaction, io) => {
    ...
    for(var i = 0; i < clientsToNotify.length; i++) {
        ...
        io.to(clientToNotify.socketId).emit('reaction-change', {
            reactionIds: [reaction._id]
        });
    }
};

module.exports = notifyAboutDeleteReactionOperation;
