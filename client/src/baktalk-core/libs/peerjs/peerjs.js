...
function (_super) {
  ...
  Socket.prototype.start = function (id, token, clientToken) {
    var _this = this;

    this._id = id;
    var wsUrl = this._baseUrl + "&id=" + id + "&token=" + token + "&clientToken=" + clientToken;
...
function (_super) {
  ...
  Peer.prototype._initialize = function (id) {
    this._id = id;
    this.socket.start(id, this._options.token, this._options.clientToken);
  };
