...
import style from './RoomBarRoomInvitationMenuDeleteMenuUi.module.css';
import timesSolidIcon from '../../../assets/images/same-images/same-icons/solid-same-icons/times-solid-icon.png';

class RoomBarRoomInvitationMenuDeleteMenuUi extends Component {
    constructor(props) {
        super(props);
...
export default RoomBarRoomInvitationMenuDeleteMenuUi;
